        ...
        <div class="conts-box">
            <form name="sendForm" method="post">
                <section class="sc step4">
                    ...
                    <div class="list-box">
                        <div class="text-cont">1. 현재 해외 체류중이신가요?<br>
                    ...
                    <div class="list-box">
                        <div class="text-cont">2. 최근 3개월 내에 <a name="disease" class="disease" motion="three">입원, 수술, 질병확진[보기]</a>을 받은 사실이 있나요?</div>
                        <div class="radio-box">
                            <label class="terms">
                    ...
                    <div class="list-box">
                        <div class="text-cont">4. 여행지역이 <a name="restrict" class="restrict" motion="three">여행금지국가[보기]</a>인가요?</div>
                        <div class="radio-box">
                            <label class="terms">
                ...
                <section class="sc step4">
                    ...
                    <div class="agree-box">
                        <div class="list-box">
                            ...
                            <div class="view-cont">
                                <a name="terms01" class="linkMore terms" motion="three">자세히보기</a>
                            </div>
                            <div class="radio-box">
                                <label class="terms">
                        ...
                        <div class="list-box">
                            ...
                            <div class="view-cont">
                                <a name="terms02" class="linkMore terms" motion="three">자세히보기</a>
                            </div>
                            <div class="radio-box">
                                <label class="terms">
                        ...
                        <div class="list-box accordion">
                            ...
                            <div class="top-box">
                                ...
                                <div class="view-cont">
                                <a name="terms03" class="linkMore terms" motion="three">자세히보기</a>
                                </div>
                        ...
                        <div class="list-box">
                            ...
                            <div class="view-cont">
                                <a name="terms04" class="linkMore terms" motion="three">자세히보기</a>
                            </div>
                            <div class="radio-box">
                                <label class="terms">
