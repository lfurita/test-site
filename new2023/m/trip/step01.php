            ...
            <section class="sc step1">
                ...
                <div class="sort-box first">
                    ...
                    <div class="text-box">
                        ...
                        단, 여행 예정인 국가 중 보험인수 제한 국가가 포함되어 있을 경우 보험 가입이 불가능합니다. ( <a class="btn-restrict-popup">여행금지국가</a> 확인)<br>
                    ...
                    <ul>
                        ...
                        <li>
                            ...
                            <div class="select-box">
                                <!-- 국낸/해외 단기일경우 -->
                                <select name="trip_purpose" class="toppaste" style="display: none;">
                                    <option value="1" selected="selected">여행/관광</option>
                                    <option value="2">연수/출장</option>
                                </select>                                    
                                <!-- 해외 장기일경우 -->
                                <select name="" class="toppaste">
