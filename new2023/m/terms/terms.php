<?php
$menuNo=[5,1];
include $_SERVER['DOCUMENT_ROOT']."/meritz.new/m/include/header.php";
include $_SERVER['DOCUMENT_ROOT']."/meritz.new/m/include/sub-visual.php";
?>
...
<div class="content-wrap">
    <div class="terms-wrap">
        <ul class="clearfix inb">
            ...
            <li class="type-number">① "회사"란 이용자의 가입편의성을 위하여 보험회사와 약정한 포괄계약에 의거하여 대표계약자로 설정된 ㈜유라이프파이낸셜을 의미하며 모든 이용자는 대표계약자를 통해 청약이 이루어 집니다.</li>
            <li class="type-number">② "이용자"란 홈페이지에 접속하여 이 약관에 따라 홈페이지이 제공하는 서비스를 받는 회원 및 준회원(동반자)를 말합니다.</li>
            <li class="type-number">③ "회원"이라 함은 회사에 가입서비스의 이용을 위하여 필요한 개인정보를 입력하고 해당 약관에 동의한 자를 말합니다.</li>
            <li class="type-number">④ "준회원(동반자)"이라 함은 회원에게 개인정보를 제공하여 간접적으로 서비스를 이용하는 자를 의미합니다.</li>
            <li class="type-number">⑤ "서비스"라 함은 "회원 및 준회원이" 이용하는 것으로 회사가 요구하는 개인정보를 제공하여만 이용이 가능한 서비스(여행자보험 가입등)을 말합니다.</li>
            <li class="type-number">⑥ "준회원(동반자)"의 개인정보제공 및 동의에 관한 절차는 회원이 대신하여 진행할 수 있으나 회사의 과실을 제외한 법적책임은 회원에게 있습니다.</li>
...
<?php 
include $_SERVER['DOCUMENT_ROOT']."/meritz.new/m/include/footer.php";
?>