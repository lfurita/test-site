...
<div class="contents">
    ...
    <section class="title">
        <h2>근로자재해보장책임보험(해외)</h2>
        <p>
            근로자를 고용하고 있는 사업주(사용자)를 위한 보험으로 고용된 근로자가 업무 수행 중에 업무에 기인한 재해를
            입었을 경우 사용자가 부담해야 할 법률상 제보상을 보험자가 대신 보상하여 주는 보험으로써, 적용 사업장이 해외인 경우를
            그 대상으로 함
        </p>
    </section>
                ...
                <div class="panel prdct">
                    ...
                    <div class="short flex-start">
                        ...
                        <div class="conts">
                            ...
                            <p class="type-dot">해외사업장은 산재보험 의무 가입대상이 아니므로, <span class="fc-red">재해보상(WC)과 사용자배상책임 (EL)을 함께 가입합니다.</span></p>
                        </div>
                    </div>
                    ...
                    <div class="short">
                        ...
                        <div class="conts">
                            ...
                            <p>해외 사업장은 산재보험 가입대상에서 제외됩니다. 해외 사업장에서 사업을 영위하는 사업자가 근로자의 재해에 대비하여 근로자재해보장책임보험(해외)에 가입하며, 해sd외 사업장별로 보험계약을 체결</p>
                        </div>
                    </div>
                    ...
                    <div class="short flex-start">
                        ...
                        <div class="conts">
                            ...
                            <ul>
                                <li>
                                    <strong>해외 사업장별로 보험계약을 체결하며 청약 시 구비서류는 다음과 같습니다.</strong>
                                </li>
                                <li class="type-dot">사업자 등록증 사본</li>
                                <li class="type-dot">해외사업장(공사내용 등) 관련서류 사본</li>
                                <li class="type-dot">근로자 명세서 (서명, 직책, 연 임금 총액 명기)</li>
                            </ul>
                        </div>
                    </div>
                </div>
