    ...
    <div class="servContents">
        ...
        <div class="conts-box">
            ...
            <div class="indvd-bsns">
                <div class="selector">
                    <input type="radio" id="mkStart" name="mk">
                    <label for="mkStart">시작</label>
                </div>
                
                <div class="selector">
                    <input type="radio" id="mkDesig" name="mk" checked>
                ...
                <ul>
                    ...
                    <li class="fees">
                        ...
                        <div class="select-custom bord-left">
                            <select name="" id="">
                                ...
                                <option value="" selected>자사</option>
                    ...
                    <li>
                        <div class="select-custom">
                            <select name="" id=""  onchange="rsnCnclt(this)">
                                <option value="심사">심사</option>
                                <option value="상담/설계" selected>상담/설계</option>
                                <option value="계약완료">계약완료</option>
                                <option value="reasonCnclt" name="cancel"  motion="three">취소</option>
                            </select>
                        </div>
                    </li>
                        ...
                        <div class="second-wrap">
                            ...
                            <div class="select-custom">
                                <select name="" id="">
                                    ...
                                    <option value="" selected>홍길순</option>
                                </select>
                            </div>
                        </div>
                    </li>
                ...
                <ul>
                    ...
                    <li class="third">
                        <div class="third-wrap">
                            기본 :<input type="number" name="" id="" placeholder="0"> %
                        </div>

                        <span>+</span>
                        
                        <div class="third-wrap">
                            추가 :<input type="number" name="" id="" placeholder="0"> %
                        </div>
                    </li>                    
            ...
            <div class="btn-box-conts">
                <a name="info" class="button point btn-modal" motion="three">등록</a>
            </div>
            
            <h2 class="subtitle">작업</h2>
            <div class="write-table mgT10">
                <ul>
                    <li class="title3">
                        <strong>김성일</strong>
                    
                        <a href="" class="button file-btn"><i class="icon-file">저장 아이콘</i>저장</a>
                    </li>

                    <li class="first task-wrap">
                        <div class="task-box">
                            <div class="radiobox">
                                <input id="task1" class="radio-custom" name="taskGr" type="radio" checked>
                                <label for="task1" class="radio-custom-label">전화</label>
                            </div>
                            <div class="radiobox">
                                <input id="task2" class="radio-custom"name="taskGr" type="radio">
                                <label for="task2" class="radio-custom-label">이메일</label>
                            </div>
                            <div class="radiobox">
                                <input id="task3" class="radio-custom"name="taskGr" type="radio">
                                <label for="task3" class="radio-custom-label">방문</label>
                            </div>
                            <div class="radiobox">
                                <input id="task4" class="radio-custom"name="taskGr" type="radio">
                                <label for="task4" class="radio-custom-label">견적발행</label>
                            </div>
                        </div>

                        <textarea name="" id="" class="textarea1" placeholder="추가 사항 입력"></textarea>
            ...
            <div class="history-box mgT10 mgB30">
                <ul>
                    <li>
                        <div class="title">
...
<!-- 모달창으로 넘기기 -->
<?php 
include $_SERVER['DOCUMENT_ROOT']."/CRM/modal/reason-cancel.php"; 
include $_SERVER['DOCUMENT_ROOT']."/CRM/modal/cmplt-cntrc.php";
?>    
